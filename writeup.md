...
In  code cell 20, I implemented a pipeline `process_image` function which takes in an image as a parameter and ouputs an image with bounding boxes highlighting detected vehicles.
